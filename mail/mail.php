...
$site_top = "https://kyoyasai.mirko.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "catfish.m@nifty.com,haych207@city.kyoto.lg.jp";
...
$Referer_check_domain = "kyoyasai.mirko.jp";
...
$subject = "KyoYasai 京育カードバトル　Kyoto Lovers WEBサイトからのメール";
...
<div align="center">
<h3 style="color:#000;">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h3>
<?php echo $errm; ?><br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()" class="button">
</div>

<?php }else{ ?>
<br /><br />
<h3 style="color:#000;">以下の内容で間違いがなければ、「送信する」ボタンを押してください。</h3>
...
<input type="button" value="前画面に戻る" onClick="history.back()" class="button"></p>
</form>
<?php } ?>
...
<br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()" class="button">
</div>
</body>
</html>
<?php }else{ ?>
<br /><br /><br /><h3 style="color:#000;">送信ありがとうございました。送信は正常に完了しました。</h3><br /><br /><br />
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div align="center"><br /><br /><h3 style="color:#000;">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h3><div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()"></div>
<?php 
